...
const val KEY_SOLD: String = "key_sold"
const val KEY_TIMER: String = "key_timer"
...
class MainActivity : AppCompatActivity(), LifecycleObserver {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (savedInstanceState != null) {
            ...
            desserTimer.secondsCount = savedInstanceState.getInt(KEY_TIMER, 0)
            showCurrentDessert()
        }
    ...
    override fun onSaveInstanceState(outState: Bundle) {
        ...
        Timber.i("onSaved was called")
        outState.putInt(KEY_REVENUE, revenue)
        outState.putInt(KEY_SOLD, dessertsSold)
        outState.putInt(KEY_TIMER, desserTimer.secondsCount)
    }
